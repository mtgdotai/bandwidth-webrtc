...
function BWPhone(config) {
	...
	var configSchema = Joi.object().keys({
		...
		incomingRingUrl : Joi.string().optional()
	})
	...
	var uaConfig = {
		...
		userAgentString   : "BW WebRTC Client"
	};
	...
	var incomingCallAudio =  new global.Audio(config.incomingRingUrl || globalConfig.incomingCallAudio);
