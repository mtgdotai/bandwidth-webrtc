...
function BWPhone(config) {
	//var defaultDomain = "webrtc.bwincubator.com";
	//var defaultDomain = "prod.ringto.bwsip.io";
	var defaultDomain = "test.webrtc.stage.bwc-clients.com";
	var self = this;
	var logLevel = "log";
	var configSchema = {
	...
	var uaConfig = {
		...
		//wsServers         : [ "ws://webrtc.bwincubator.com:10080" ],
		//wsServers         : [ "ws://rocket.bwincubator.com:10080" ],
	...
	//extracts a user friendly id that call() can correctly parse back into a sip uri
	//ex: "sip:+12223334444@domain.com" will return "+12223334444"
	function getId (uri) {
